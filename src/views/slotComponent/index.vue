...
import CardTest from "@/views/slotComponent/components/CardTest.vue";
export default {
  name: "index",
  components:{Child,OtherChild,ScopeSlot,Card,CardTest},
  data(){
    return {
      title:'名人名言',
      list:[
...
<!--    <div>-->
<!--      <child>-->
<!--        &lt;!&ndash;v-slot can only be used on components or <template> tags.&ndash;&gt;-->
